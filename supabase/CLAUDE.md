...
| `SUPABASE_SERVICE_ROLE_KEY`  | gsd-mentor-chat, gsd-generate-plan, gsd-onboarding-chat, gsd-mock-interview, gsd-practice-feedback, gsd-reset-user-data      | Admin client for rate limit table / data deletion / mock interview writes / practice feedback                                                                                                                    |
| `GEMINI_API_KEY`             | gsd-mentor-chat, gsd-generate-plan, gsd-onboarding-chat, gsd-interview-onboarding, gsd-mock-interview, gsd-practice-feedback | Google Generative AI API key                                                                                                                                                                                     |
