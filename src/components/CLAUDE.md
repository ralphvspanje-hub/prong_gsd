...
| Component | Purpose |
|-----------|---------|
| **Layout.tsx** | App shell: sticky header with nav links (Today, Plan, Progress, History, Settings, Mentor), theme toggle, sign out button. Mobile bottom nav hides History (5 items). Footer. Wraps all protected pages. |
...
| **MistakeJournalDisplay.tsx** | Dashboard widget showing recent mistakes from `mistake_journal`. Pattern detection (e.g., "3 of your last 10 mistakes are Communication"). Shown only in interview_prep view mode. |
