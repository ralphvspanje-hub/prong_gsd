...
| **TaskItem.tsx** | Individual task: checkbox, platform badge (colored), time estimate, resource link/search URL, expandable why text. Framer Motion animation on completion. |
