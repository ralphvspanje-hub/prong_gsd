...
const Auth = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div
        className="flex flex-col md:flex-row rounded-2xl border border-border overflow-hidden shadow-lg w-full max-w-5xl"
        style={{
        ...
        <div className="hidden md:flex md:w-3/5 flex-col items-center justify-center gap-6 p-8">
          <div className="max-w-md text-center space-y-3">
            ...
            <p className="text-base text-foreground/80 leading-relaxed">
              The T-shape is the past; multiple is the future. Broaden your
              horizons, but dig deep into two or three distinct fields. It's
              where these areas overlap that your greatest ambition becomes
              reality.
            </p>
